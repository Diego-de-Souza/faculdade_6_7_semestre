...
class OldShiftRegisterData extends OldClockState implements InstanceData {
	private BitWidth width;
	private Value[] vs;
	private int vsPos;
	
	public OldShiftRegisterData(BitWidth width, int len) {
		this.width = width;
	...
	@Override
	public OldShiftRegisterData clone() {
		OldShiftRegisterData ret = (OldShiftRegisterData) super.clone();

...
public class OldShiftRegisterPoker extends InstancePoker {
	private int loc;
	...
	private int computeStage(InstanceState state, MouseEvent e) {
		Integer lenObj = state.getAttributeValue(OldShiftRegister.ATTR_LENGTH);
		BitWidth widObj = state.getAttributeValue(StdAttr.WIDTH);
		Boolean loadObj = state.getAttributeValue(OldShiftRegister.ATTR_LOAD);

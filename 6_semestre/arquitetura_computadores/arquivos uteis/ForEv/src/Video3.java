...
// 256 x 256 pixel LCD display with 8bpp color (byte addressed)
class Video3 extends ManagedComponent {
    ...
    private static class Factory extends AbstractComponentFactory {
        private Factory() { }
        public String getName() { return "LCD Video 256x256x24"; }
        public String getDisplayName() { return "LCD Video 256x256x24"; }
        public AttributeSet createAttributeSet() {
            return AttributeSets.fixedSet(ATTRIBUTES, new Object[] { BLINK_OPTIONS[0], RESET_OPTIONS[0] });
        }
        public Component createComponent(Location loc, AttributeSet attrs) { return new Video3(loc, attrs); }
    ...
    private Video3(Location loc, AttributeSet attrs) {
        super(loc, attrs, 6);

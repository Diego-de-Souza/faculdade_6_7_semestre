...
abstract class OldAbstractFlipFlop extends InstanceFactory {
	private static final int STD_PORTS = 6;
	
	private Attribute<AttributeOption> triggerAttribute;
	
	protected OldAbstractFlipFlop(String name, String iconName, StringGetter desc,
	...
	public void propagate(InstanceState state) {
		...
		state.setPort(n + 1, data.curValue, ForEv.DELAY);
		state.setPort(n + 2, data.curValue.not(), ForEv.DELAY);
	}
	...
	private static class StateData extends OldClockState implements InstanceData {

...
class OldRomContentsListener implements HexModelListener {
	private static class Change extends Action {
		private OldRomContentsListener source;
		...
		Change(OldRomContentsListener source, OldMemContents contents,
	...
	OldRomContentsListener(Project proj) {
		this.proj = proj;
	}
	...
	public void bytesChanged(HexModel source, long start,
		...
		if (enabled && proj != null && oldValues != null) {
			...
			proj.doAction(new Change(this, (OldMemContents) source,

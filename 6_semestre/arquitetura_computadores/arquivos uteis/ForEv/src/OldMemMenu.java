...
class OldMemMenu implements ActionListener, MenuExtender {
	private OldMem factory;
	...
	OldMemMenu(OldMem factory, Instance instance) {
	...
	private void doEdit() {
		OldMemState s = factory.getState(instance, circState);
		if (s == null) return;

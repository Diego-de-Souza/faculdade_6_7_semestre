...
// 256 x 256 pixel LCD display with 8bpp (not really) color (byte addressed)
class Video2 extends ManagedComponent {
    ...
    private static class Factory extends AbstractComponentFactory {
        private Factory() { }
        public String getName() { return "LCD Video 256x256x16(555)"; }
        public String getDisplayName() { return "LCD Video 256x256x16(555)"; }
        public AttributeSet createAttributeSet() {
            return AttributeSets.fixedSet(ATTRIBUTES, new Object[] { BLINK_OPTIONS[0], RESET_OPTIONS[0] });
        }
        public Component createComponent(Location loc, AttributeSet attrs) { return new Video2(loc, attrs); }
    ...
    private Video2(Location loc, AttributeSet attrs) {
        super(loc, attrs, 6);
